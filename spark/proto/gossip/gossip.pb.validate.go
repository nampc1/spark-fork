...
func (m *GossipMessage) validate(all bool) error {
	...
	case *GossipMessage_ArchiveStaticDepositAddress:
		if v == nil {
			err := GossipMessageValidationError{
				field:  "Message",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetArchiveStaticDepositAddress()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GossipMessageValidationError{
						field:  "ArchiveStaticDepositAddress",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetArchiveStaticDepositAddress()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GossipMessageValidationError{
					field:  "ArchiveStaticDepositAddress",
					reason: "embedded message failed validation",
	...
	case *GossipMessage_RollbackInstantUtxoSwap:
		if v == nil {
			err := GossipMessageValidationError{
				field:  "Message",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetRollbackInstantUtxoSwap()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GossipMessageValidationError{
						field:  "RollbackInstantUtxoSwap",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetRollbackInstantUtxoSwap()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GossipMessageValidationError{
					field:  "RollbackInstantUtxoSwap",
					reason: "embedded message failed validation",
	...
	case *GossipMessage_FinalizeTransferReceiver:
		if v == nil {
			err := GossipMessageValidationError{
				field:  "Message",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetFinalizeTransferReceiver()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GossipMessageValidationError{
						field:  "FinalizeTransferReceiver",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetFinalizeTransferReceiver()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GossipMessageValidationError{
					field:  "FinalizeTransferReceiver",
					reason: "embedded message failed validation",
...
// Validate checks the field values on GossipMessageFinalizeTransferReceiver
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *GossipMessageFinalizeTransferReceiver) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GossipMessageFinalizeTransferReceiver
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GossipMessageFinalizeTransferReceiverMultiError, or nil if none found.
func (m *GossipMessageFinalizeTransferReceiver) ValidateAll() error {
	return m.validate(true)
}

func (m *GossipMessageFinalizeTransferReceiver) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetInternalNodes() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GossipMessageFinalizeTransferReceiverValidationError{
						field:  fmt.Sprintf("InternalNodes[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return GossipMessageFinalizeTransferReceiverValidationError{
					field:  fmt.Sprintf("InternalNodes[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GossipMessageFinalizeTransferReceiverMultiError(errors)
	}

	return nil
}

// GossipMessageFinalizeTransferReceiverMultiError is an error wrapping
// multiple validation errors returned by
// GossipMessageFinalizeTransferReceiver.ValidateAll() if the designated
// constraints aren't met.
type GossipMessageFinalizeTransferReceiverMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GossipMessageFinalizeTransferReceiverMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GossipMessageFinalizeTransferReceiverMultiError) AllErrors() []error { return m }

// GossipMessageFinalizeTransferReceiverValidationError is the validation error
// returned by GossipMessageFinalizeTransferReceiver.Validate if the
// designated constraints aren't met.
type GossipMessageFinalizeTransferReceiverValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GossipMessageFinalizeTransferReceiverValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GossipMessageFinalizeTransferReceiverValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GossipMessageFinalizeTransferReceiverValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GossipMessageFinalizeTransferReceiverValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GossipMessageFinalizeTransferReceiverValidationError) ErrorName() string {
	return "GossipMessageFinalizeTransferReceiverValidationError"
}

// Error satisfies the builtin error interface
func (e GossipMessageFinalizeTransferReceiverValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGossipMessageFinalizeTransferReceiver.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GossipMessageFinalizeTransferReceiverValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GossipMessageFinalizeTransferReceiverValidationError{}
...
// Validate checks the field values on GossipMessageRollbackInstantUtxoSwap
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *GossipMessageRollbackInstantUtxoSwap) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GossipMessageRollbackInstantUtxoSwap
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GossipMessageRollbackInstantUtxoSwapMultiError, or nil if none found.
func (m *GossipMessageRollbackInstantUtxoSwap) ValidateAll() error {
	return m.validate(true)
}

func (m *GossipMessageRollbackInstantUtxoSwap) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GossipMessageRollbackInstantUtxoSwapValidationError{
					field:  "OnChainUtxo",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GossipMessageRollbackInstantUtxoSwapValidationError{
				field:  "OnChainUtxo",
				reason: "embedded message failed validation",
				cause:  err,
			}
...
// GossipMessageRollbackInstantUtxoSwapMultiError is an error wrapping multiple
// validation errors returned by
// GossipMessageRollbackInstantUtxoSwap.ValidateAll() if the designated
// constraints aren't met.
type GossipMessageRollbackInstantUtxoSwapMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GossipMessageRollbackInstantUtxoSwapMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GossipMessageRollbackInstantUtxoSwapMultiError) AllErrors() []error { return m }

// GossipMessageRollbackInstantUtxoSwapValidationError is the validation error
// returned by GossipMessageRollbackInstantUtxoSwap.Validate if the designated
// constraints aren't met.
type GossipMessageRollbackInstantUtxoSwapValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GossipMessageRollbackInstantUtxoSwapValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GossipMessageRollbackInstantUtxoSwapValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GossipMessageRollbackInstantUtxoSwapValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GossipMessageRollbackInstantUtxoSwapValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GossipMessageRollbackInstantUtxoSwapValidationError) ErrorName() string {
	return "GossipMessageRollbackInstantUtxoSwapValidationError"
}

// Error satisfies the builtin error interface
func (e GossipMessageRollbackInstantUtxoSwapValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGossipMessageRollbackInstantUtxoSwap.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GossipMessageRollbackInstantUtxoSwapValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GossipMessageRollbackInstantUtxoSwapValidationError{}
...
// Validate checks the field values on GossipMessageArchiveStaticDepositAddress
// with the rules defined in the proto definition for this message. If any
// rules are violated, the first error encountered is returned, or nil if
// there are no violations.
func (m *GossipMessageArchiveStaticDepositAddress) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on
// GossipMessageArchiveStaticDepositAddress with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in
// GossipMessageArchiveStaticDepositAddressMultiError, or nil if none found.
func (m *GossipMessageArchiveStaticDepositAddress) ValidateAll() error {
	return m.validate(true)
}

func (m *GossipMessageArchiveStaticDepositAddress) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GossipMessageArchiveStaticDepositAddressMultiError(errors)
	}

	return nil
}

// GossipMessageArchiveStaticDepositAddressMultiError is an error wrapping
// multiple validation errors returned by
// GossipMessageArchiveStaticDepositAddress.ValidateAll() if the designated
// constraints aren't met.
type GossipMessageArchiveStaticDepositAddressMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GossipMessageArchiveStaticDepositAddressMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GossipMessageArchiveStaticDepositAddressMultiError) AllErrors() []error { return m }

// GossipMessageArchiveStaticDepositAddressValidationError is the validation
// error returned by GossipMessageArchiveStaticDepositAddress.Validate if the
// designated constraints aren't met.
type GossipMessageArchiveStaticDepositAddressValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GossipMessageArchiveStaticDepositAddressValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GossipMessageArchiveStaticDepositAddressValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GossipMessageArchiveStaticDepositAddressValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GossipMessageArchiveStaticDepositAddressValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GossipMessageArchiveStaticDepositAddressValidationError) ErrorName() string {
	return "GossipMessageArchiveStaticDepositAddressValidationError"
}

// Error satisfies the builtin error interface
func (e GossipMessageArchiveStaticDepositAddressValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGossipMessageArchiveStaticDepositAddress.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GossipMessageArchiveStaticDepositAddressValidationError{}
