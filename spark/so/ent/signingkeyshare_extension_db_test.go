...
func TestAggregateKeyshares_PersistsSecretVersion(t *testing.T) {
	t.Parallel()
	...
	require.Equal(t, version, *persisted.SecretVersion)
...
func TestAggregateKeyshares_VersionMismatchDoesNotModifyTarget(t *testing.T) {
	t.Parallel()
	...
	originalPublicKey := target.PublicKey
	originalPublicShares := target.PublicShares
	...
	require.NoError(t, err)
	require.NotNil(t, persisted.SecretVersion)
	require.Equal(t, targetVersion, *persisted.SecretVersion)
	require.NotNil(t, persisted.SecretShare)
	require.True(t, persisted.SecretShare.Equals(originalSecret))
	require.True(t, persisted.PublicKey.Equals(originalPublicKey))
	require.Equal(t, originalPublicShares, persisted.PublicShares)
}

func TestCalculateAndStoreLastKey_PersistsSecretVersion(t *testing.T) {
	t.Parallel()
	...
	require.NoError(t, err)
	require.NotNil(t, lastKey.SecretVersion)
	require.Equal(t, version, *lastKey.SecretVersion)
