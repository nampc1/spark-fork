...
// SecretShareIsNil applies the IsNil predicate on the "secret_share" field.
func SecretShareIsNil() predicate.SigningKeyshare {
	return predicate.SigningKeyshare(sql.FieldIsNull(FieldSecretShare))
}
