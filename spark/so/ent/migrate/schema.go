...
var (
	...
	TransfersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "idx_transfers_outgoing_in_flight_sender_pubkey_time",
				Unique:  false,
				Columns: []*schema.Column{TransfersColumns[3], TransfersColumns[1], TransfersColumns[0]},
				Annotation: &entsql.IndexAnnotation{
					DescColumns: map[string]bool{
	...
	TransferPartnersColumns = []*schema.Column{
		...
		{Name: "create_time", Type: field.TypeTime},
		{Name: "update_time", Type: field.TypeTime},
		{Name: "type", Type: field.TypeEnum, Enums: []string{"LIGHTNING_SEND", "LIGHTNING_RECEIVE", "TRANSFER", "COOPERATIVE_EXIT", "DEPOSIT"}},
