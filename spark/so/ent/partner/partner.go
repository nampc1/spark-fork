...
const (
	...
	Table = "partners"
	// PartnerKeyTable is the table that holds the partner_key relation/edge.
	PartnerKeyTable = "partners"
	// PartnerKeyInverseTable is the table name for the PartnerKey entity.
	// It exists in this package in order to avoid circular dependency with the "partnerkey" package.
	PartnerKeyInverseTable = "partner_keys"
	// PartnerKeyColumn is the table column denoting the partner_key relation/edge.
	PartnerKeyColumn = "partner_partner_key"
)
...
func ByPartnerKeyField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newPartnerKeyStep(), sql.OrderByField(field, opts...))
	}
}
func newPartnerKeyStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(PartnerKeyInverseTable, FieldID),
