...
export function sparkTransactionTypeFromJSON(object: any): SparkTransactionType {
  switch (object) {
    case 0:
    case "SPARK_TRANSACTION_TYPE_UNSPECIFIED":
      return SparkTransactionType.SPARK_TRANSACTION_TYPE_UNSPECIFIED;
    case 1:
    case "SPARK_TRANSACTION_TYPE_TRANSFER":
      return SparkTransactionType.SPARK_TRANSACTION_TYPE_TRANSFER;
    case 2:
    case "SPARK_TRANSACTION_TYPE_LIGHTNING_SEND":
      return SparkTransactionType.SPARK_TRANSACTION_TYPE_LIGHTNING_SEND;
    case 3:
    ...
    case "UNRECOGNIZED":
    default:
      return SparkTransactionType.UNRECOGNIZED;
  }
}

export function sparkTransactionTypeToJSON(object: SparkTransactionType): string {
  switch (object) {
    case SparkTransactionType.SPARK_TRANSACTION_TYPE_UNSPECIFIED:
      return "SPARK_TRANSACTION_TYPE_UNSPECIFIED";
    case SparkTransactionType.SPARK_TRANSACTION_TYPE_TRANSFER:
      return "SPARK_TRANSACTION_TYPE_TRANSFER";
    case SparkTransactionType.SPARK_TRANSACTION_TYPE_LIGHTNING_SEND:
...
export interface SubscribeToEventsResponse {
  event?:
    ...
    | { $case: "tokenTransaction"; tokenTransaction: TokenTransactionEvent }
    | undefined;
}
...
export interface SparkTransactionVolume {
  transactionType: SparkTransactionType;
  volumeSats: number;
  transactionCount: number;
}

export interface QuerySparkTransactionVolumesResponse {
  partnerId: string;
  label: string;
  startDate: string;
  endDate: string;
  transactionTypes: SparkTransactionVolume[];
...
export const SubscribeToEventsResponse: MessageFns<SubscribeToEventsResponse> = {
  encode(message: SubscribeToEventsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.event?.$case) {
      ...
      case "tokenTransaction":
        TokenTransactionEvent.encode(message.event.tokenTransaction, writer.uint32(50).fork()).join();
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.event = {
            $case: "tokenTransaction",
            tokenTransaction: TokenTransactionEvent.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
  ...
  fromJSON(object: any): SubscribeToEventsResponse {
    return {
      event: isSet(object.transfer)
        ...
        : isSet(object.tokenTransaction)
        ? { $case: "tokenTransaction", tokenTransaction: TokenTransactionEvent.fromJSON(object.tokenTransaction) }
        : undefined,
    };
  },
  ...
  toJSON(message: SubscribeToEventsResponse): unknown {
    ...
    } else if (message.event?.$case === "tokenTransaction") {
      obj.tokenTransaction = TokenTransactionEvent.toJSON(message.event.tokenTransaction);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SubscribeToEventsResponse>): SubscribeToEventsResponse {
    ...
    switch (object.event?.$case) {
      ...
      case "tokenTransaction": {
        if (object.event?.tokenTransaction !== undefined && object.event?.tokenTransaction !== null) {
          message.event = {
            $case: "tokenTransaction",
            tokenTransaction: TokenTransactionEvent.fromPartial(object.event.tokenTransaction),
          };
        }
        break;
      }
...
function createBaseTokenTransactionEvent(): TokenTransactionEvent {
  return { tokenTransactionHash: new Uint8Array(0), tokenIdentifiers: [], sparkInvoices: [] };
}

export const TokenTransactionEvent: MessageFns<TokenTransactionEvent> = {
  encode(message: TokenTransactionEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.sparkInvoices) {
      writer.uint32(26).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TokenTransactionEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTokenTransactionEvent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.sparkInvoices.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TokenTransactionEvent {
    return {
      ...
      tokenIdentifiers: globalThis.Array.isArray(object?.tokenIdentifiers)
        ...
        : [],
      sparkInvoices: globalThis.Array.isArray(object?.sparkInvoices)
        ? object.sparkInvoices.map((e: any) => globalThis.String(e))
        : [],
    };
  },

  toJSON(message: TokenTransactionEvent): unknown {
    const obj: any = {};
    if (message.tokenTransactionHash.length !== 0) {
    ...
    if (message.sparkInvoices?.length) {
      obj.sparkInvoices = message.sparkInvoices;
    }
    return obj;
  },

  create(base?: DeepPartial<TokenTransactionEvent>): TokenTransactionEvent {
    return TokenTransactionEvent.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TokenTransactionEvent>): TokenTransactionEvent {
    const message = createBaseTokenTransactionEvent();
    ...
    message.sparkInvoices = object.sparkInvoices?.map((e) => e) || [];
    return message;
  },
};
...
export const QuerySparkTransactionVolumesRequest: MessageFns<QuerySparkTransactionVolumesRequest> = {
  encode(message: QuerySparkTransactionVolumesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySparkTransactionVolumesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): QuerySparkTransactionVolumesRequest {
    return {
  ...
  toJSON(message: QuerySparkTransactionVolumesRequest): unknown {
    const obj: any = {};
    if (message.startDate !== "") {
  ...
  create(base?: DeepPartial<QuerySparkTransactionVolumesRequest>): QuerySparkTransactionVolumesRequest {
    return QuerySparkTransactionVolumesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QuerySparkTransactionVolumesRequest>): QuerySparkTransactionVolumesRequest {
    const message = createBaseQuerySparkTransactionVolumesRequest();
...
function createBaseSparkTransactionVolume(): SparkTransactionVolume {
  return { transactionType: 0, volumeSats: 0, transactionCount: 0 };
}

export const SparkTransactionVolume: MessageFns<SparkTransactionVolume> = {
  encode(message: SparkTransactionVolume, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.transactionType !== 0) {
      writer.uint32(8).int32(message.transactionType);
    }
    if (message.volumeSats !== 0) {
      writer.uint32(16).int64(message.volumeSats);
    }
    if (message.transactionCount !== 0) {
      writer.uint32(24).int64(message.transactionCount);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SparkTransactionVolume {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSparkTransactionVolume();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.volumeSats = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.transactionCount = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SparkTransactionVolume {
    return {
      transactionType: isSet(object.transactionType) ? sparkTransactionTypeFromJSON(object.transactionType) : 0,
      volumeSats: isSet(object.volumeSats) ? globalThis.Number(object.volumeSats) : 0,
      transactionCount: isSet(object.transactionCount) ? globalThis.Number(object.transactionCount) : 0,
    };
  },

  toJSON(message: SparkTransactionVolume): unknown {
    const obj: any = {};
    if (message.transactionType !== 0) {
      obj.transactionType = sparkTransactionTypeToJSON(message.transactionType);
    }
    if (message.volumeSats !== 0) {
      obj.volumeSats = Math.round(message.volumeSats);
    }
    if (message.transactionCount !== 0) {
  ...
  create(base?: DeepPartial<SparkTransactionVolume>): SparkTransactionVolume {
    return SparkTransactionVolume.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SparkTransactionVolume>): SparkTransactionVolume {
    const message = createBaseSparkTransactionVolume();
    message.transactionType = object.transactionType ?? 0;
    message.volumeSats = object.volumeSats ?? 0;
    message.transactionCount = object.transactionCount ?? 0;
    return message;
  },
};

function createBaseQuerySparkTransactionVolumesResponse(): QuerySparkTransactionVolumesResponse {
  return {
    partnerId: "",
    label: "",
    startDate: "",
...
export const QuerySparkTransactionVolumesResponse: MessageFns<QuerySparkTransactionVolumesResponse> = {
  encode(message: QuerySparkTransactionVolumesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.transactionTypes) {
      SparkTransactionVolume.encode(v!, writer.uint32(42).fork()).join();
    }
    if (message.totalVolumeSats !== 0) {
      writer.uint32(48).int64(message.totalVolumeSats);
    }
    if (message.totalTransactionCount !== 0) {
      writer.uint32(56).int64(message.totalTransactionCount);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QuerySparkTransactionVolumesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQuerySparkTransactionVolumesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 5: {
          ...
          message.transactionTypes.push(SparkTransactionVolume.decode(reader, reader.uint32()));
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.totalVolumeSats = longToNumber(reader.int64());
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.totalTransactionCount = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuerySparkTransactionVolumesResponse {
    return {
      ...
      endDate: isSet(object.endDate) ? globalThis.String(object.endDate) : "",
      transactionTypes: globalThis.Array.isArray(object?.transactionTypes)
        ? object.transactionTypes.map((e: any) => SparkTransactionVolume.fromJSON(e))
        : [],
      totalVolumeSats: isSet(object.totalVolumeSats) ? globalThis.Number(object.totalVolumeSats) : 0,
      totalTransactionCount: isSet(object.totalTransactionCount) ? globalThis.Number(object.totalTransactionCount) : 0,
    };
  },

  toJSON(message: QuerySparkTransactionVolumesResponse): unknown {
    const obj: any = {};
    if (message.partnerId !== "") {
    ...
    if (message.transactionTypes?.length) {
      obj.transactionTypes = message.transactionTypes.map((e) => SparkTransactionVolume.toJSON(e));
    }
    if (message.totalVolumeSats !== 0) {
      obj.totalVolumeSats = Math.round(message.totalVolumeSats);
    }
    if (message.totalTransactionCount !== 0) {
      obj.totalTransactionCount = Math.round(message.totalTransactionCount);
    }
    return obj;
  },

  create(base?: DeepPartial<QuerySparkTransactionVolumesResponse>): QuerySparkTransactionVolumesResponse {
    return QuerySparkTransactionVolumesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<QuerySparkTransactionVolumesResponse>): QuerySparkTransactionVolumesResponse {
    const message = createBaseQuerySparkTransactionVolumesResponse();
    message.partnerId = object.partnerId ?? "";
    message.label = object.label ?? "";
    message.startDate = object.startDate ?? "";
    message.endDate = object.endDate ?? "";
    message.transactionTypes = object.transactionTypes?.map((e) => SparkTransactionVolume.fromPartial(e)) || [];
    message.totalVolumeSats = object.totalVolumeSats ?? 0;
    message.totalTransactionCount = object.totalTransactionCount ?? 0;
    return message;
  },
};
...
export const SparkServiceDefinition = {
  ...
  methods: {
    ...
    query_spark_transaction_volumes: {
      name: "query_spark_transaction_volumes",
      requestType: QuerySparkTransactionVolumesRequest,
      requestStream: false,
      responseType: QuerySparkTransactionVolumesResponse,
      responseStream: false,
      options: {},
    },
  },
...
export interface SparkServiceImplementation<CallContextExt = {}> {
  ...
  query_spark_transaction_volumes(
    request: QuerySparkTransactionVolumesRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<QuerySparkTransactionVolumesResponse>>;
}
...
export interface SparkServiceClient<CallOptionsExt = {}> {
  ...
  query_spark_transaction_volumes(
    request: DeepPartial<QuerySparkTransactionVolumesRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<QuerySparkTransactionVolumesResponse>;
}
